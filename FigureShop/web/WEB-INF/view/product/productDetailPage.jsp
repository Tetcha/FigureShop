      ...
      <%@page import="product.models.Product" %>
        ...
        <body>
          ...
          <% Locale vi=new Locale("vi", "VN" ); NumberFormat vndFormat=NumberFormat.getCurrencyInstance(vi); String
            pattern="product.hstatic.net" ; String imageHead="https://" ; %>
            <div class="bg-white">
              <div
                  ...
                  <div class="lg:max-w-lg lg:self-start">
                    ...
                    <div class="flex flex-col mt-6">
                      <div class="flex flex-col">
                        ...
                        <input min="1" max="999" name="quantity" type="number" value="1"
                      ...
                      <input name="id" type="text" value="${requestScope.product.getId()}" class="hidden" />
