...
<li class="flex py-6 sm:py-10">
  ...
  <div class="ml-4 flex-1 flex flex-col justify-between sm:ml-6 w-80">
    <div class="relative pr-9 sm:grid sm:grid-cols-1 sm:gap-x-6 sm:pr-0 w-80">
      <div>
  ...
  <form action="<%= Router.CART_REMOVE_PRODUCT_CONTROLLER%>" method="get">
    <input type="text" class="hidden" name="productId" value="${param.id}" />
    <button type="submit">
      <svg
